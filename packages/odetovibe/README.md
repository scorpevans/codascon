...
**Odetovibe** reads a declarative YAML schema describing your codascon domain — entity types, operations, and dispatch strategies — and generates the TypeScript scaffolding that enforces the protocol. On re-generation, existing method bodies and business logic are preserved.
